                ...
                (function() {
                    function e(g) {
                        ...
                        this.tick = function(h, m, f) {
                            var n = f != void 0 ? f : (new Date).getTime();
                            this.t[h] = [n, m];
                            if (f == void 0)
                                try {
                    ...
                    if (a) {
                        ...
                        b > 0 && d >= b && (window.jstiming.srt = d - b)
                    }
                    if (a) {
                        var c = window.jstiming.load;
                        b > 0 && d >= b && (c.tick("_wtsrt", void 0, b),
                        c.tick("wtsrt_", "_wtsrt", d),
                        c.tick("tbsd_", "wtsrt_"))
                    }
                    try {
                        ...
                        a = null;
                        window.chrome && window.chrome.csi && (a = Math.floor(window.chrome.csi().pageT),
                        c && b > 0 && (c.tick("_tbnd", void 0, window.chrome.csi().startE),
                        c.tick("tbnd_", "_tbnd", b)));
                        a == null && window.gtbExternal && (a = k ? window.gtbExternal.frameT(l) : window.gtbExternal.pageT());
                        a == null && window.external && (k ? a = window.external.frameT(l) : (a = window.external.pageT,
                        c && b > 0 && (c.tick("_tbnd", void 0, window.external.startE),
                        c.tick("tbnd_", "_tbnd", b))));
...
*/
            ...
            goog.readToggleInternalDoNotCallDirectly = function(a) {
                var b = goog.CLOSURE_TOGGLE_ORDINALS;
                a = b && b[a];
            ...
            goog.loadModule = function(a) {
                ...
                try {
                    ...
                    if (typeof e === "string" && e) {
                        goog.moduleLoaderState_.declareLegacyNamespace ? (a = c !== d,
                        goog.constructNamespace_(e, d, a)) : goog.SEAL_MODULE_EXPORTS && Object.seal && typeof d == "object" && d != null && Object.seal(d);
                        var f = {
                            exports: d,
                            type: goog.ModuleType.GOOG,
            ...
            google.csi = function() {
                ...
                function c() {
                    if (!l) {
                        ...
                        (r = window.gadgets) && r.rpc && m.b && (f.url = h,
                        f.id = a("mid"),
                        r.rpc.call(null, "time_iframe", void 0, f));
                        l = !0
                    }
                }
                function d(h) {
