...
function playdooranimationright(inReverse) {
    if (inReverse == 0) {
        for (x = 0; x < (14); x++) {
            ...
            setTimeout(function(number) {
                doorrightdiv.attr("src", doorrightanim[number].src);
            }, (30 * (x + 1)), x);
        }
    } else if (inReverse == 1) {
        for (x = 13; x >= (0); x--) {
...
function playcamerafeedanimation(inReverse) {
    if (inReverse == 0) {
        ...
        for (x = 0; x < (10); x++) {
            ...
            setTimeout(function(number) {
                camerafeedanimationdiv.attr("src", camerafeedanimationimage[number].src);
            }, (30 * (x + 1)), x);
            //eval('setTimeout(function(){camerafeedanimationdiv.css("display","none");},(330));')
            setTimeout(function() {
                camerafeedanimationdiv.css("display", "none");
            }, (330));
        }
    } else if (inReverse == 1) {
        camerafeedanimationdiv.css("display", "block");
        ...
        case "2a":
            for (x = 0; x < (9); x++) {
                if (randomnumber > 0.5) {
                    ...
                    setTimeout(function(number) {
                        roomdiv.attr("src", room2aimage[(number & 1)].src);
                    }, (45 * (Math.abs(x + 1))), x);
                } else {
...
function playdooranimationleft(inReverse) {
    if (inReverse == 0) {
        for (x = 0; x < (14); x++) {
            ...
            setTimeout(function(number) {
                doorleftdiv.attr("src", doorleftanim[number].src);
            }, (30 * (x + 1)), x);
        }
    } else if (inReverse == 1) {
        for (x = 13; x >= (0); x--) {
