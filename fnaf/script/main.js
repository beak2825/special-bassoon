...
function endnight() {
    ...
    setTimeout(function() {
        nightover5div.animate({
            top: "140px"
        }, 6000, "linear", function() {
            // Animation complete.
        });
        nightover6div.animate({
            top: "80px"
        }, 6000, "linear", sound.playSound("CROWD_SMALL_CHIL_EC049202.wav"));
    }, 1500);
    setTimeout(function() {
...
function updatedifficulty(animatronic, negativepositive) {
    switch (animatronic) {
        case "foxxy":
            if (negativepositive && foxydifficulty != 20) {
                foxydifficulty++;
            } else if (negativepositive == false && foxydifficulty != 0) {
                foxydifficulty--;
            };
            ...
            break;
        case "bunny":
            if (negativepositive && bunnydifficulty != 20) {
                bunnydifficulty++;
            } else if (negativepositive == false && bunnydifficulty != 0) {
                bunnydifficulty--;
            };
            ...
            break;
        case "freddy":
            if (negativepositive && freddydifficulty != 20) {
                freddydifficulty++;
            } else if (negativepositive == false && freddydifficulty != 0) {
                freddydifficulty--;
            };
            ...
            break;
        case "chica":
            if (negativepositive && chicadifficulty != 20) {
                chicadifficulty++;
            } else if (negativepositive == false && chicadifficulty != 0) {
                chicadifficulty--;
            };
        ...
        if (rand > 0.8) {
            for (x = 0; x < (6); x++) {
                ...
                setTimeout(function(number) {
                    mainmenufazbearanimdiv.attr("src", mainmenufazbear[(number & 3)].src);
                }, (65 * (Math.abs(x + 1))), x);
            };
            ...
            for (x = 0; x < (7); x++) {
                ...
                setTimeout(function(number) {
                    mainmenufazbearanimdiv.attr("src", mainmenufazbear[(number & 2)].src);
                }, (45 * (Math.abs(x + 1))));
            };
            ...
            for (x = 0; x < (7); x++) {
                ...
                setTimeout(function(number) {
                    mainmenufazbearanimdiv.attr("src", mainmenufazbear[(number & 1)].src);
                }, (25 * (Math.abs(x + 1))));
            };
        } else {
