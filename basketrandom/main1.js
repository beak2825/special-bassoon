...
window.C3_IsSupported) {
    ...
    window.c3_runtimeInterface = new RuntimeInterface({
        useWorker: !1,
        workerMainUrl: "https://cdn.jsdelivr.net/gh/only-games/only-games.github.io/projects/basket-random/scripts/workermain.js",
        engineScripts: ["https://cdn.jsdelivr.net/gh/only-games/only-games.github.io/projects/basket-random/scripts/c3runtime.js"],
        scriptFolder: "https://cdn.jsdelivr.net/gh/only-games/only-games.github.io/projects/basket-random/scripts/",
        ...
        _OnNavigate(e) {
            ...
            if ("back" === t)
                ...
                const t = e.url
                  , n = e.target
                  , a = e.exportType;
                "windows-uwp" === a && "undefined" != typeof Windows ? Windows.System.Launcher.launchUriAsync(new Windows.Foundation.Uri(t)) : "cordova" === a ? window.op3n(t, "_system") : "preview" === a ? window.op3n(t, "_blank") : !this._isScirraArcade && (2 === n ? window.top.location = t : 1 === n ? window.parent.location = t : window.location = t)
            } else if ("new-window" === t) {
                const t = e.url
                  , n = e.tag
                  , a = e.exportType;
                "windows-uwp" === a && "undefined" != typeof Windows ? Windows.System.Launcher.launchUriAsync(new Windows.Foundation.Uri(t)) : "cordova" === a ? window.op3n(t, "_system") : window.op3n(t, n)
            }
        }
