(function() {
  ...
  // Event listener for key presses to change the speed
  window.addEventListener("keydown", (event) => {
    switch (event.key) {
      case "1":
        ...
        break;
      case "2":
        speedConfig.speed = 0.3;
        break;
      case "3":
        speedConfig.speed = 0.7;
        break;
      case "4":
        speedConfig.speed = 2.0;
        break;
      case "5":
    ...
    reloadTimers();
    console.log(`Speed set to: ${speedConfig.speed}x`);
  });
})();
