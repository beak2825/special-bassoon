...
async function fetchComments() {
    try {
        const response = await fetch('https://script.google.com/a/macros/carthagecsd.org/s/AKfycbzoojIK52K2WU-UsULozoyOSSvwELF_WkAQH6GjOOqpVUVNL9mFG59-6NVOt64rQi4_xA/exec?get');
...
function postComment(text) {
    ...
    const url = `https://script.google.com/a/macros/carthagecsd.org/s/AKfycbzoojIK52K2WU-UsULozoyOSSvwELF_WkAQH6GjOOqpVUVNL9mFG59-6NVOt64rQi4_xA/exec?${queryParams.toString()}`;
