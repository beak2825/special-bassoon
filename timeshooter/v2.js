...
(() => {
    var e = {
            ...
            2861: (e, t, r) => {
                ...
                function isPlayPageInAppPage() {
                    return "object" == typeof window && -1 !== window.location.href.indexOf("is-app-page") && !1
                }
                const s = new class Messaging {
                        constructor() {
                            this._promises = Object.create(null), this._externalListeners = Object.create(null), this._internalListeners = Object.create(null), this.receivedMessages = [], this._addEventListener()
                        }
                        get _parentTarget() {
                        ...
                        get _gameFrame() {
                            ...
                            return e || console.warn("No frame to post"), e
                        }
                        ...
                        _addEventListener() {
                            window.addEventListener("message", (e => {
                                ...
                                if ("YandexGamesSDK" === r) return isPlayPageInAppPage() && window !== window.parent && e.source === window.parent && e.origin === window.location.origin ? (this.post(e.data), void("messaging" === n && "confirm" === t ? this.receivedMessages.push(o) : o && s.postToParent({
                                    type: "messaging",
                                    action: "confirm",
                                    uuid: o
                                }))) : void(window.top === window && this._gameFrameAllowedOrigin && this._gameFrameAllowedOrigin !== e.origin ? console.error('Ignore message. event.origin = "'.concat(e.origin, '" is not allowed.')) : this._handleEvent(e))
                            }))
                        }
                        _handleEvent(e) {
                            const {
                            ...
                            p && (delete this._promises[o], void 0 === u ? p.resolve({
                                type: t,
                                action: r,
                                originPayload: s,
                                data: c
                            }) : p.reject(function createErrorInstance({
                                error: e,
                                errorJSON: t
                            }) {
                                let r;
                                ...
                                return r && r.name in i ? new i[r.name](r) : new Error(e)
                            }({
                                error: u,
                                errorJSON: l
                            })));
                            const sendCallback = (e = {}) => {
                                ...
                                }(o, e), this.postCallbackToChild(o)
                            };
                        ...
                        post(e) {
                            ...
                            return new Promise((n => {
                                const o = "".concat(Date.now(), "-").concat(Math.random()),
                                    sendCallback = (e = {}) => {
                                        const a = {
                                            action: e.action || t,
                                            data: e.data || {},
                        ...
                        postToParent(e) {
                            ...
                            return t ? (!isPlayPageInAppPage() || "messaging" === e.type && "confirm" === e.action || (e.uuid = Math.random().toString(36).substring(2, 15), setTimeout((() => {
                                e.uuid && !this.receivedMessages.includes(e.uuid) && this.postToParent(e)
                            }), 500)), this._post(t, e)) : Promise.reject(new Error("No parent to post message"))
                        }
                        hasChild() {
            ...
            9274: (e, t, r) => {
                ...
                function getAppId() {
                    ...
                    const e = String(window.location).match(a);
            ...
            260: (e, t, r) => {
                ...
                if ((!O || "function" != typeof w || w === Function.prototype) && (w = function TypedArray() {
                    ...
                    for (n in C) i[n] && h(i[n], w);
                if ((!O || !E || E === A) && (E = w.prototype, O))
                    for (n in C) i[n] && h(i[n].prototype, E);
                if (O && f(b) !== E && h(b, E), a && !c(E, P))
                    for (n in T = !0, d(E, P, {
                            get: function() {
            ...
            3331: (e, t, r) => {
                ...
                var n = r(7854),
                    ...
                    set = function(e, t, r, n, o, a) {
                        ...
                        for (var c = w(s.buffer).bytes, u = i + s.byteOffset, l = n(+o), p = 0; p < t; p++) c[u + p] = l[a ? p : t - p - 1]
                    };
                if (a) {
                    if (!c((function() {
                            x(1)
                            ...
                            return new x, new x(1.5), new x(NaN), x.name != A
                        }))) {
                        for (var D, M = (O = function ArrayBuffer(e) {
                                return u(this, O), new x(d(e))
                            }).prototype = x.prototype, U = _(x), j = 0; U.length > j;)(D = U[j++]) in O || i(O, D, x[D]);
                        M.constructor = O
                    }
                    g && h(C) !== k && g(C, k);
                    var N = new T(new O(2)),
                        G = C.setInt8;
                    N.setInt8(0, 2147483648), N.setInt8(1, 2147483649), !N.getInt8(0) && N.getInt8(1) || s(C, {
                ...
                }, o && (addGetter(O, "byteLength"), addGetter(T, "buffer"), addGetter(T, "byteLength"), addGetter(T, "byteOffset")), s(T.prototype, {
            ...
            8457: (e, t, r) => {
                ...
                e.exports = function from(e) {
                    ...
                    if (m && (v = n(v, _ > 2 ? arguments[2] : void 0, 2)), null == y || g == Array && i(y))
                        for (r = new g(t = s(h.length)); t > b; b++) f = m ? v(h[b], b) : h[b], c(r, b, f);
                    else
                        for (d = (p = y.call(h)).next, r = new g; !(l = d.call(p)).done; b++) f = m ? a(p, v, [l.value, b], !0) : l.value, c(r, b, f);
                    return r.length = b, r
                }
            },
            1318: (e, t, r) => {
                ...
                var n = r(9974),
                    ...
                    createMethod = function(e) {
                        ...
                        return function(h, g, _, v) {
                            for (var m, y, b = a(h), w = o(b), E = n(g, _, 3), A = i(w.length), S = 0, P = v || s, x = t ? P(h, A) : r || d ? P(h, 0) : void 0; A > S; S++)
                                if ((f || S in w) && (y = E(m = w[S], S, b), e))
                                    if (t) x[S] = y;
                                    else if (y) switch (e) {
                                case 3:
                                    return !0;
            ...
            654: (e, t, r) => {
                ...
                e.exports = function(e, t, r, l, f, b, w) {
                    ...
                    var E, A, S, getIterationMethod = function(e) {
                        ...
                        x = !1,
                        O = e.prototype,
                        T = O[_] || O["@@iterator"] || f && O[f],
                        C = !g && T || getIterationMethod(f),
                        k = "Array" == t && O.entries || T;
                    if (k && (E = a(k.call(new e)), h !== Object.prototype && E.next && (p || a(E) === h || (i ? i(E, h) : "function" != typeof E[_] && c(E, _, returnThis)), s(E, P, !0, !0), p && (d[P] = returnThis))), f == m && T && T.name !== m && (x = !0, C = function values() {
                            return T.call(this)
                        }), p && !w || O[_] === C || c(O, _, C), d[t] = C, f)
                        if (A = {
                                values: getIterationMethod(m),
                                keys: b ? C : getIterationMethod(v),
                                entries: getIterationMethod(y)
                            }, w)
                            for (S in A)(g || x || !(S in O)) && u(O, S, A[S]);
                        else n({
                            target: t,
                            proto: !0,
                            forced: g || x
            ...
            408: (e, t, r) => {
                ...
                e.exports = function(e, t, r) {
                    var u, l, p, d, f, h, g, _ = r && r.that,
                        ...
                        callFn = function(e) {
                            return v ? (n(e), y ? b(e[0], e[1], stop) : b(e[0], e[1])) : y ? b(e, stop) : b(e)
                        };
                    if (m) u = e;
                    else {
            ...
            5948: (e, t, r) => {
                ...
                E || (n = function() {
                    ...
                    a = void 0, e && e.enter()
                }, h || _ || g || !v || !m ? b && b.resolve ? (u = b.resolve(void 0), l = u.then, i = function() {
                    l.call(u, n)
                }) : i = _ ? function() {
                    y.nextTick(n)
                } : function() {
                            ...
                            for (l += (h - u) * g, u = h, n = 0; n < e.length; n++) {
                                ...
                                if (s == u) {
                                    for (var _ = l, v = 36;; v += 36) {
                                        ...
                                        var y = _ - m,
                                            b = 36 - m;
                                        r.push(i(digitToBasic(m + y % b))), _ = a(y / b)
                                    }
            ...
            261: (e, t, r) => {
                ...
                h && g || (h = function setImmediate(e) {
                    ...
                    m.now(runner(e))
                } : v && !p ? (a = (o = new v).port2, o.port1.onmessage = listener, n = c(a.postMessage, a, 1)) : i.addEventListener && "function" == typeof postMessage && !i.importScripts && f && "file:" !== f.protocol && !s(post) ? (n = post, i.addEventListener("message", listener, !1)) : n = w in l("script") ? function(e) {
            ...
            9843: (e, t, r) => {
                ...
                var n = r(2109),
                    ...
                    fromList = function(e, t) {
                        for (var r = 0, n = t.length, o = new(B(e))(n); n > r;) o[r] = t[r++];
                        return o
                    },
                    addGetter = function(e, t) {
                        I(e, t, {
                    ...
                    V = function getOwnPropertyDescriptor(e, t) {
                        return isTypedArrayIndex(e, t = g(t, !0)) ? l(2, e[t]) : L(e, t)
                    },
                    W = function defineProperty(e, t, r) {
                ...
                a ? (j || (x.f = V, P.f = W, addGetter(H, "buffer"), addGetter(H, "byteOffset"), addGetter(H, "byteLength"), addGetter(H, "length")), n({
                    target: "Object",
                    stat: !0,
                    forced: !j
                }, {
                            ...
                            I(e, t, {
                                ...
                                set: function(e) {
                                    return function(e, t, n) {
                                        var o = C(e);
                                        r && (n = (n = R(n)) < 0 ? 0 : n > 255 ? 255 : 255 & n), o.view[l](t * a + o.byteOffset, n, !0)
                                    }(this, t, e)
                                },
                                enumerable: !0
                            })
                    ...
                    j ? i && (_ = t((function(e, t, r, n) {
                        return u(e, _, s), T(m(t) ? isArrayBuffer(t) ? void 0 !== n ? new g(t, h(r, a), n) : void 0 !== r ? new g(t, h(r, a)) : new g(t) : q(t) ? fromList(_, t) : E.call(_, t) : new g(f(t)), e, _)
                    })), b && b(_, G), A(w(g), (function(e) {
                        e in _ || p(_, e, g[e])
                        ...
                        var o, i, c, l = 0,
                            p = 0;
                        if (m(t)) {
                            if (!isArrayBuffer(t)) return q(t) ? fromList(_, t) : E.call(_, t);
                            o = t, p = h(r, a);
                            var g = t.byteLength;
                            if (void 0 === n) {
                                if (g % a) throw D(K);
                                if ((i = g - p) < 0) throw D(K)
                            } else if ((i = d(n) * a) + p > g) throw D(K);
                            c = i / a
                    ...
                    })), b && b(_, G), v = _.prototype = y(H)), v.constructor !== _ && p(v, "constructor", _), N && p(v, N, s), P[s] = _, n({
                        global: !0,
                        forced: _ != g,
                        sham: !j
                    }, P), Y in _ || p(_, Y, a), Y in v || p(v, Y, a), S(s)
                }) : e.exports = function() {}
            },
            3832: (e, t, r) => {
                var n = r(7854),
            ...
            8674: (e, t, r) => {
                ...
                var n, o, a, i, s = r(2109),
                            ...
                            S((function() {
                                for (var n = e.value, o = 1 == e.state, a = 0; r.length > a;) {
                                    var i, s, c, u = r[a++],
                                        ...
                                        f = u.domain;
                                    try {
                                        l ? (o || (2 === e.rejection && onHandleUnhandled(e), e.rejection = 1), !0 === l ? i = n : (f && f.enter(), i = l(n), f && (f.exit(), c = !0)), i === u.promise ? d(H("Promise-chain cycle")) : (s = isThenable(i)) ? s.call(i, p, d) : p(i)) : d(n)
                                    } catch (h) {
                                        f && !c && f.exit(), d(h)
                                    }
                                }
                    ...
                    dispatchEvent = function(e, t, r) {
                        var n, o;
                        W ? ((n = B.createEvent("Event")).promise = t, n.reason = r, n.initEvent(e, !1, !0), u.dispatchEvent(n)) : n = {
                            promise: t,
                            reason: r
                        }, !Z && (o = u["on" + e]) ? o(n) : e === z && x("Unhandled promise rejection", r)
                    },
                    onUnhandled = function(e) {
                        A.call(u, (function() {
                            ...
                            if (isUnhandled(e) && (t = T((function() {
                                    L ? q.emit("unhandledRejection", n, r) : dispatchEvent(z, r, n)
                                })), e.rejection = L || isUnhandled(e) ? 2 : 1, t.error)) throw t.value
                        }))
                    },
                    ...
                    onHandleUnhandled = function(e) {
                        A.call(u, (function() {
                            var t = e.facade;
                            L ? q.emit("rejectionHandled", t) : dispatchEvent("rejectionhandled", t, e.value)
                        }))
                    },
                    bind = function(e, t, r) {
                        return function(n) {
                ...
                $ && (G = function Promise(e) {
                    ...
                    then: function then(e, t) {
                        var r = N(this),
                            n = K(E(this, G));
                        return n.ok = "function" != typeof e || e, n.fail = "function" == typeof t && t, n.domain = L ? q.domain : void 0, r.parent = !0, r.reactions.push(n), 0 != r.state && notify(r, !1), n.promise
                    },
                    catch: function(e) {
                    ...
                    fetch: function fetch(e) {
                        return P(G, Y.apply(u, arguments))
                    }
                }))), s({
                    global: !0,
                    wrap: !0,
            ...
            4603: (e, t, r) => {
                ...
                if (n && a("RegExp", !w || E || f((function() {
                        return b[_] = !1, v(y) != y || v(b) == b || "/a/i" != v(y, "i")
                    })))) {
                    for (var A = function RegExp(e, t) {
                            ...
                            w ? o && !a && (e = e.source) : e instanceof A && (a && (t = l.call(e)), e = e.source), E && (r = !!t && t.indexOf("y") > -1) && (t = t.replace(/y/g, ""));
            ...
            2087: (e, t, r) => {
                ...
                n && ("g" != /./g.flags || i) && o.f(RegExp.prototype, "flags", {
                    configurable: !0,
                    get: a
                })
            },
            ...
            5306: (e, t, r) => {
                ...
                n("replace", 2, (function(e, t, r, n) {
                    ...
                    return [function replace(r, n) {
                        ...
                        for (var A, S = "", P = 0, x = 0; x < w.length; x++) {
                            E = w[x];
                            for (var O = String(E[0]), T = p(d(i(E.index), v.length), 0), C = [], k = 1; k < E.length; k++) C.push(void 0 === (A = E[k]) ? A : String(A));
                            var I = E.groups;
                            if (m) {
                                var L = [O].concat(C, T, v);
                                void 0 !== I && L.push(I);
                                var R = String(n.apply(void 0, L))
                            } else R = u(O, v, T, C, I, n);
                            T >= P && (S += v.slice(P, T) + R, P = T + O.length)
                        }
                        return S + v.slice(P)
                    }]
                }))
            ...
            1637: (e, t, r) => {
                ...
                var n = r(2109),
                    ...
                    serialize = function(e) {
                        return encodeURIComponent(e).replace(L, replacer)
                    },
                ...
                var n, o = r(2109),
                    ...
                    parseHost = function(e, t) {
                        ...
                        if ("[" == t.charAt(0)) {
                            ...
                            if (!(r = parseIPv6(t.slice(1, -1)))) return O;
                            e.host = r
                        } else if (isSpecial(e)) {
                            if (t = g(t), U.test(t)) return O;
                            if (null === (r = parseIPv4(t))) return O;
                            e.host = r
                        } else {
                            if (j.test(t)) return O;
                            for (r = "", n = f(t), o = 0; o < n.length; o++) r += percentEncode(n[o], H);
                            e.host = r
                        }
                    },
                    parseIPv4 = function(e) {
                        ...
                        for (r = [], n = 0; n < t; n++) {
                            if ("" == (o = c[n])) return e;
                            if (a = 10, o.length > 1 && "0" == o.charAt(0) && (a = L.test(o) ? 16 : 8, o = o.slice(8 == a ? 1 : 2)), "" === o) i = 0;
                            else {
                                if (!(10 == a ? D : 8 == a ? R : M).test(o)) return e;
                                i = parseInt(o, a)
                            }
                            r.push(i)
                        }
                    ...
                    parseURL = function(e, t, r, o) {
                        var a, i, s, c, u, l = r || V,
                            ...
                            _ = !1,
                            v = !1;
                        for (r || (e.scheme = "", e.username = "", e.password = "", e.host = null, e.port = null, e.path = [], e.query = null, e.fragment = null, e.cannotBeABaseURL = !1, t = t.replace(N, "")), t = t.replace(G, ""), a = f(t); d <= a.length;) {
                            switch (i = a[d], l) {
                                case V:
                                    if (!i || !C.test(i)) {
                                        if (r) return x;
                                    ...
                                    if (!I.test(i)) {
                                        if (i == n || "/" == i || "?" == i || "#" == i || "\\" == i && isSpecial(e) || r) {
                                            if ("" != h) {
                                                var w = parseInt(h, 10);
                                                if (w > 65535) return T;
                                                e.port = isSpecial(e) && w === K[e.scheme] ? null : w, h = ""
                                            }
                                            if (r) return;
                                            l = ce;
                                            continue
                                ...
                                case ue:
                                    ...
                                    } else h += percentEncode(i, q);
                                    break;
                                case le:
                                    "?" == i ? (e.query = "", l = pe) : "#" == i ? (e.fragment = "", l = de) : i != n && (e.path[0] += percentEncode(i, H));
                                    break;
                                case pe:
                                    r || "#" != i ? i != n && ("'" == i && isSpecial(e) ? e.query += "%27" : e.query += "#" == i ? "%23" : percentEncode(i, H)) : (e.fragment = "", l = de);
                                    break;
                                case de:
                                    i != n && (e.fragment += percentEncode(i, B))
                            }
                            d++
                        }
                    },
                ...
                if (a && c(he, {
                        ...
                        username: accessorDescriptor(getUsername, (function(e) {
                            ...
                            if (!cannotHaveUsernamePasswordPort(t)) {
                                t.username = "";
                                for (var n = 0; n < r.length; n++) t.username += percentEncode(r[n], Y)
                            }
                        })),
                        password: accessorDescriptor(getPassword, (function(e) {
                            ...
                            if (!cannotHaveUsernamePasswordPort(t)) {
                                t.password = "";
                                for (var n = 0; n < r.length; n++) t.password += percentEncode(r[n], Y)
                            }
                        })),
                        ...
                        search: accessorDescriptor(getSearch, (function(e) {
                            var t = A(this);
                            "" == (e = String(e)) ? t.query = null: ("?" == e.charAt(0) && (e = e.slice(1)), t.query = "", parseURL(t, e, pe)), w(t.searchParams).updateSearchParams(t.query)
                        })),
                    ...
                    if (S) n(e, r, S);
                        ...
                        if (x) {
                            var O = u(A),
                                T = !O && p(A),
                                C = !O && !T && g(A);
                            P = A, O || T || C ? u(E) ? P = E : l(E) ? P = i(E) : T ? (x = !1, P = o(A, !0)) : C ? (x = !1, P = a(A, !0)) : P = [] : h(A) || c(A) ? (P = E, c(E) ? P = v(E) : f(E) && !d(E) || (P = s(A))) : x = !1
                        }
                        x && (w.set(A, P), y(P, A, m, b, w), w.delete(A)), n(e, r, P)
                    }
                }
            },
            5976: (e, t, r) => {
    ...
    (() => {
        ...
        var e = __webpack_require__(2861);
        __webpack_require__(4603), __webpack_require__(4916), __webpack_require__(6992), __webpack_require__(3948);
        const t = [{
                regexp: new RegExp("User .+ already exists in users list!"),
                title: "User already exists in users list!"
            }, {
                regexp: new RegExp("\\[Multiplayer\\] Peer '.*' \\(.*\\) error:"),
                title: "[Multiplayer] Peer error"
            }, {
                ...
                substr: "looks like it points into the shape? The vertices follow.",
                title: "cannon.js"
            }, {
                ...
                regexp: new RegExp("^Peer '.*?' datachannel '.*?' error"),
                title: '"Peer datachannel error"'
            }, {
                substr: "pre-main prep time: ",
                title: '"pre-main prep time"'
            }, {
                regexp: new RegExp("ReferenceError: .{6}$"),
            ...
            prepare_error_event = e => {
                const r = (e => e.map((e => {
                        if ("object" == typeof e) try {
                            ...
                            return "".concat(e, ": ").concat(t.message)
                        }
                        return String(e)
                    })).join(" "))(e),
                    n = (e => {
                        for (const r of t)
                            if (r.regexp && -1 !== e.search(r.regexp) || r.substr && e.includes(r.substr)) return {
                                message: "[grouped] Error related to ".concat(r.title),
                                additional: {
                                    message: e
                                }
                            };
                ...
                return n.additional && (o.additional = n.additional), o
            };
        const n = new class ErrorCounter {
            constructor() {
                window.addEventListener("error", this), "Promise" in window && window.addEventListener("unhandledrejection", this)
            }
            setEnv(e) {
                this._env = e
            }
            ...
            _handleEvent(e, t = "error") {
                try {
                    ...
                    console.log("Couldn't handle event in ErrorCounter!", r)
                }
            }
            ...
            _unsafeHandlePromiseRejectionEvent(e) {
                ...
                let r;
                const n = {};
                t.stack && t.message ? r = t.message : (r = String(t), "[object Event]" === r ? r = "event.type: " + t.type : "[object Object]" === r && (n.unhandledObject = t)), t.target && t.target.src && (n.src = t.target.src), this._postErrorToParent({
                    additional: n,
            ...
            _unsafeHandleErrorEvent(e, t) {
                var r, n, o, a, i, s, c, u, l, p, d, f;
                const h = {
                    columnNumber: null !== (o = null !== (r = e.colno) && void 0 !== r ? r : null === (n = e.error) || void 0 === n ? void 0 : n.columnNumber) && void 0 !== o ? o : -1,
                    fileName: e.filename || (null === (a = e.error) || void 0 === a ? void 0 : a.fileName) || "",
                    lineNumber: null !== (c = null !== (i = e.lineno) && void 0 !== i ? i : null === (s = e.error) || void 0 === s ? void 0 : s.lineNumber) && void 0 !== c ? c : -1,
                    message: e.message || (null === (u = e.error) || void 0 === u ? void 0 : u.message) || "",
                    name: (null === (l = e.error) || void 0 === l ? void 0 : l.name) || "Error",
                    stack: null !== (d = null === (p = e.error) || void 0 === p ? void 0 : p.stack) && void 0 !== d ? d : ""
                };
                (null === (f = e.error) || void 0 === f ? void 0 : f.additional) && (h.additional = Object.assign({}, e.error.additional)), this._postErrorToParent(h, t)
            }
            _handleCustomError(e, t = "console.error") {
                try {
                    this._unsafeHandleCustomError(e, t)
                } catch (r) {
                    console.log("Couldn't handle custom error in ErrorCounter!", r)
                }
            }
            _unsafeHandleCustomError(e, t) {
                var r, n;
                const o = {
                    columnNumber: null !== (r = e.columnNumber) && void 0 !== r ? r : -1,
                    fileName: e.fileName || "",
                    lineNumber: null !== (n = e.lineNumber) && void 0 !== n ? n : -1,
                    name: e.name || "Error",
                    message: e.message || "",
                    stack: e.stack || ""
                };
                e.additional && (o.additional = Object.assign({}, e.additional)), this._postErrorToParent(o, t)
            }
            _postErrorToParent(t, r) {
                var n;
                e.Z.postToParent({
                    type: "error",
                    data: {
                        data: {
                            type: r,
                            additional: Object.assign(Object.assign({}, t.additional), {
                                sdkVersion: null === (n = this._env) || void 0 === n ? void 0 : n.sdkVersion
                            })
                        },
                        error: t
                    }
        ...
        ! function overrideConsoleMethods() {
            try {
                ...
                console.error = (...t) => {
                    ...
                    r || (r = prepare_error_event(t)), n._handleCustomError(r, "console.error"), e.apply(console, t)
                }
            } catch (e) {
                n._handleEvent(e, "error")
            }
        }();
        const o = n,
            back_button_logic = () => {
        ...
        var a, i = __webpack_require__(9274),
            s = (__webpack_require__(5306), __webpack_require__(8059));
        ! function(e) {
        ...
        const _ = getDebugLog("SDK env"),
            v = !0;
        _("IS_PROD", v);
        const m = (0, s.Z)(window.location),
            y = "true" === m.yandexapp,
            b = ((m.origin || void 0 || window.location.origin).match(/[\.\/]yandex\.([a-z\.]+)$/) || ["", "ru"])[1],
            w = "https://games-sdk.yandex.%TLD%/games/api/sdk/v1".replace("%TLD%", b),
            E = ("passport".concat("", ".yandex.").concat(b), "https://avatars.mds.yandex.net");
        ...
        function setTmpPlayTimeTimer(e) {
            window.setTimeout((() => {
                ...
                (new Image).src = "https://mc.yandex.ru/watch/49035923?&page-url=".concat(encodeURIComponent(window.location.href), "&page-ref=").concat(encodeURIComponent(document.referrer), "&charset=utf-8&site-info=").concat(encodeURIComponent(JSON.stringify(t)))
            }), 1e3 * e)
        }
        const A = function setTmpPlayTimeTimers() {
        ...
        function isFlagEqualTo(e, t, r) {
            const n = function getFlags(e) {
                var t;
                return (null === (t = e.abt) || void 0 === t ? void 0 : t.flags) || e
            }(e);
            return n[t] === r
        }
        let I;
        ...
        const L = I || function getInMemoryLocalStorage() {
                let e = {};
                return {
                    clear() {
                        e = {}
            ...
            R = /iPad|iPhone|iPod/.test(navigator.platform),
            D = /^((?!chrome|android).)*safari/i.test(navigator.userAgent),
            M = R || D,
            U = /app-[^.]+\.games\.s3\.yandex\.net$/.test(window.location.hostname),
            j = !U && M;
        class LocalStorageWrapper {
            static setup() {
                j && Object.defineProperty(window, "localStorage", {
                    get: function() {
                        return console.error("localStorage is broken on iOS/MacOS - https://developer.apple.com/forums/thread/109909\nPlease use YaGames.init().then(ysdk => ysdk.getStorage()).then(storage => storage.setItem('key', 'value'))"), L
                    }
                }), M && U && LocalStorageWrapper.setProxy() && LocalStorageWrapper.backup()
            }
            static load() {
                ...
                })), LocalStorageWrapper.onloadPromise_) : Promise.resolve(L)
            }
            static getCustomLocalStorage() {
                if ("function" != typeof Proxy) return null;
                return new Proxy({
                    clear() {
                        L.clear.call(L), e.Z.postToParent({
                            type: "local-storage",
                            action: "clear"
                        })
                    },
                    getItem: e => L.getItem.call(L, e),
                    key: e => L.key.call(L, e),
                    get length() {
                        return L.length
                    },
                    removeItem(t) {
                        L.removeItem.call(L, t), e.Z.postToParent({
                            type: "local-storage",
                            action: "del",
                            data: {
                                key: t
                    ...
                    setItem(t, r) {
                        L.setItem.call(L, t, String(r)), e.Z.postToParent({
                            type: "local-storage",
                            action: "set",
                            data: {
                                key: t,
        ...
        function getStorage() {
            return !M && I ? Promise.resolve(I) : LocalStorageWrapper.load()
        }
        LocalStorageWrapper.onloadPromise_ = null;
        const N = new class Shortcut {
            canShowPrompt() {
        ...
        const G = getDebugLog("NoAds"),
            H = "yandex-games-no-ads-style";
        let B = !1;

        function disableContentAds() {
            B || (B = !0, function _disableContentAds() {
                G("_disableContentAds"),
                    ...
                    function replaceAdvManager() {
                        ...
                        const n = {
                            destroy() {
                                G("Ya.Context.AdvManager.destroy disabled")
                            },
                            render(e, t) {
                        ...
                        Object.defineProperty(window, "Ya", {
                            ...
                            AdvManager: n
                        }, window.Ya.Context.AdvManager = n, G("disable Ya.Context.AdvManager.render")
                    }()
            }())
        }
        ...
        class AdvManager {
            constructor(t) {
                this.options = t, this.adOpened = !1, this.callbacks = [], this.lastShowTime = 0, this.startTime = Date.now(), this.adv = this.options.adv || {}, e.Z.onExternalMessage("adv-manager", (e => {
                    ...
                    switch (e.data.action) {
                        ...
                        case "adv-callback-close":
                            this.adOpened = !1, this.lastShowTime = Date.now(), this._hideAdv(e.data.data.wasShown);
                            break;
                        case "adv-callback-error":
                            this.adOpened = !1, this._hideAdv(e.data.data.wasShown), null === (o = (n = this.callbacks).onError) || void 0 === o || o.call(n, new Error(e.data.data.error.message, {
                                cause: e.data.data.error
                            }));
                            break;
                        case "adv-callback-offline":
                            this.adOpened = !1, this._hideAdv(), null === (i = (a = this.callbacks).onOffline) || void 0 === i || i.call(a);
                            break;
                        ...
                        case "rewarded-video-callback-close":
                            this.adOpened = !1, null === (d = (p = this.callbacks).onClose) || void 0 === d || d.call(p);
                            break;
                        case "rewarded-video-callback-error":
                            this.adOpened = !1, null === (h = (f = this.callbacks).onError) || void 0 === h || h.call(f, new Error(e.data.data.error.message, {
                                cause: e.data.data.error
                            }));
                            break;
                        case "set-disabled-state":
                            q('On "set-disabled-state" event', e.data, e.data.data.value), this.setDisabledState(e.data.data.value)
                    }
            ...
            setDisabledState(e) {
                q("setDisabledState", e), e ? disableContentAds() : function enableContentAds() {
                    B && (B = !1)
                }()
            }
            openAdLock(e) {
                var t, r;
                if (this.adOpened) {
                    const n = new Error("Another ad already opened");
                    return console.error(n), null === (t = e.onError) || void 0 === t || t.call(e, n), null === (r = e.onClose) || void 0 === r || r.call(e), !1
                }
                return this.adOpened = !0, !0
            }
            showFullscreenAdv({
                callbacks: t = {}
            } = {}) {
                if (this.openAdLock(t)) return this._addCallbacks(t, ["onClose", "onOpen", "onError", "onOffline"]), e.Z.postToParent({
                    type: "adv-manager",
                    action: "adv-show-fullscreen"
                }).catch((e => {
                    var t, r;
                    console.error("Please, send this error sdk developers: ".concat(e)), null === (r = (t = this.callbacks).onError) || void 0 === r || r.call(t, e), this._hideAdv()
                })), this
            }
            showRewardedVideo({
                callbacks: t = {}
            } = {}) {
                if (this.openAdLock(t)) return this._addCallbacks(t, ["onOpen", "onRewarded", "onClose", "onError"]), e.Z.postToParent({
                    type: "adv-manager",
                    action: "adv-show-rewarded-video"
                }).catch((e => {
                    var t, r;
                    this.adOpened = !1, console.error("Please, send this error sdk developers: ".concat(e)), null === (r = (t = this.callbacks).onError) || void 0 === r || r.call(t, e)
                })), this
            }
            _hideAdv(e = !1) {
                this._callOnAdvClose(e), e && (this.lastShowTime = Date.now())
            }
            _addCallbacks(e, t) {
                t.forEach((t => {
                    this.callbacks[t] = "function" == typeof e[t] ? function errorDecorator(e, t = "", r) {
                        return (...n) => {
                            try {
                                return e(...n)
                            } catch (o) {
                                console.error(t, o), r && r(o)
                            }
                        }
                    }(e[t], "Error in callback ".concat(t, ": ")) : () => {}
                }))
            }
            _callOnAdvClose(e = !1) {
                var t, r;
                ...
                null === (r = (t = this.callbacks).onClose) || void 0 === r || r.call(t, e)
            }
        }
        const Y = getDebugLog("AuthManagerPrivate");
        const K = new class AuthManagerPrivate {
            constructor() {
            ...
            initMessaging() {
                e.Z.onExternalMessage("auth", this.onExternalAuthMessage)
            }
            switchAuthState(e) {
                this.hasAuthValue !== e && (Y("switch auth state to ".concat(e)), this.hasAuthValue = e)
            }
            getAuthState() {
                e.Z.postToParent({
                    type: "auth",
            ...
            hasAuth() {
                return void 0 === this.hasAuthValue && (console.error("AuthManagerPrivate.hasAuth() called when state is not defined"), this.hasAuthValue = !0), this.hasAuthValue
            }
        };
        const V = new class AuthManagerPublic {
            openAuthDialog() {
                return e.Z.postToParent({
                    type: "auth",
        ...
        const W = new class ClipboardPublic {
                writeText(t) {
                    try {
                        t = String(t)
                    } catch (r) {
            ...
            Z = {
                android: () => !Z.windows() && find("android"),
                androidPhone: () => Z.android() && find("mobile"),
                androidTablet: () => Z.android() && !find("mobile"),
                blackberry: () => find("blackberry") || find("bb10") || find("rim"),
                blackberryPhone: () => Z.blackberry() && !find("tablet"),
                blackberryTablet: () => Z.blackberry() && find("tablet"),
                cordova: () => Boolean(window.cordova && "file:" === window.location.protocol),
                desktop: () => !Z.tablet() && !Z.mobile(),
                fxos: () => (find("(mobile") || find("(tablet")) && find(" rv:"),
                fxosPhone: () => Z.fxos() && find("mobile"),
                fxosTablet: () => Z.fxos() && find("tablet"),
                ios: () => Z.iphone() || Z.ipod() || Z.ipad(),
                ipad: () => find("ipad"),
                iphone: () => !Z.windows() && find("iphone"),
                ipod: () => find("ipod"),
                landscape: function() {
                ...
                meego: () => find("meego"),
                mobile: function() {
                    return Z.androidPhone() || Z.iphone() || Z.ipod() || Z.windowsPhone() || Z.blackberryPhone() || Z.fxosPhone() || Z.meego()
                },
                ...
                tablet: function() {
                    return Z.ipad() || Z.androidTablet() || Z.blackberryTablet() || Z.windowsTablet() || Z.fxosTablet()
                },
                tv: () => $.some((e => find(e))),
                get type() {
                ...
                windowsPhone: () => Z.windows() && find("phone"),
                windowsTablet: () => Z.windows() && find("touch") && !Z.windowsPhone()
            },
            z = "undefined" == typeof window ? "" : window.navigator.userAgent.toLowerCase(),
            $ = ["googletv", "viera", "smarttv", "internet.tv", "netcast", "nettv", "appletv", "boxee", "kylo", "roku", "dlnadoc", "pov_tv", "hbbtv", "ce-html", "yandexmodule"];
        ...
        let getEnv = () => (window.YandexGamesSDKEnvironment || console.error("SDK environment: `window.YandexGamesSDKEnvironment` is undefined"), getEnv = () => window.YandexGamesSDKEnvironment || Q, getEnv());
        const ee = {
            get app() {
                return getEnv().app
            },
        ...
        var te = __webpack_require__(7114);
        const re = __webpack_require__(4089).default;
        x.L, x.RECOMMENDED_NEW, x.PREMIUM_BIG, x.TV;
        var ne;
        ! function(e) {
        ...
        const oe = "0/0-0",
            ae = {
                small: ne.ISLANDS_RETINA_SMALL,
                medium: ne.ISLANDS_RETINA_MEDIUM,
                large: ne.ISLANDS_200
            },
            ie = {
                small: ne.ISLANDS_200,
                medium: ne.ISLANDS_200,
                large: ne.BIG
            },
            se = "".concat(w, "/player"),
            ce = "".concat(E, "/get-yapic/");
        var ue = __webpack_require__(208);
        ...
        const le = "".concat(w, "/leaderboard"),
            fetch_fetchData = (e, t = {}) => commonFetchData({
                api: le,
                timeout: 3e3,
                path: e,
                params: t,
            ...
            pe = throttle(((e, t, r = {}) => commonPostData({
                api: le,
                timeout: 3e3,
                path: e,
                data: t,
        ...
        class Leaderboards {
            ...
            transformLeaderboardEntry(e) {
                const {
                    ...
                    scopePermissions: o,
                    uniqueID: a
                } = e.player, i = "".concat(se, "/avatar/").concat(t);
                return Object.assign(Object.assign({}, e), {
                    player: {
                        getAvatarSrc: (e = "medium") => (ae[e] || (e = "medium"), "".concat(i, "/").concat(ae[e])),
                        getAvatarSrcSet: (e = "medium") => (ae[e] || (e = "medium"), "".concat(i, "/").concat(ae[e], " 1x, ").concat(i, "/").concat(ie[e], " 2x")),
                        lang: r,
                        publicName: n,
                        scopePermissions: o,
                        uniqueID: a
            ...
            setLeaderboardScore(e, t, r) {
                ...
                return r && (n.extraData = r), pe("/score", n)
            }
        }
        const leaderboards = () => {
        ...
        var fe, he = __webpack_require__(2492),
            ge = __webpack_require__.n(he);
                    ...
                    return function ensurePartner(e) {
                        ...
                        function ensureScreen(e) {
                            ...
                            return t = function ensureFullscreen(e) {
                                ...
                                }(e.fullscreen) : e.fullscreen = !X.isDesktop();
                                return e
        ...
        function getSdkEventsHandler() {
            ...
            function getEventListeners(e) {
                const r = t[e];
                return r || console.warn("Yandex SDK Event ".concat(e, " is not in supported")), r || []
            }

            function notifyListenersChange(t) {
                e.Z.postToParent({
                    type: "sdk-internal-event",
                    action: "listeners-change",
                    data: {
                        event: t,
                        count: getEventListeners(t).length
                    }
                })
            }
            return e.Z.onExternalMessage("sdk-event", (e => {
                    const r = e.data.action;
                    r in t && getEventListeners(r).forEach((e => {
                        try {
                            e()
                        } catch (Je) {
                            console.error(Je)
                ...
                function onEvent(e, r) {
                    return e in t ? (function addEventListener(e, t) {
                    ...
                    }) : (console.warn("Yandex SDK Event", e, "is not in supported. Available events: ".concat(Object.keys(t).join)), () => {})
                }
        }
        let ve = !0;
        const me = class ScreenManager {
            constructor(e) {
                this.onMessage = e => {
                    const {
                        action: t,
            ...
            _initMessaging() {
                e.Z.onExternalMessage("screen-manager", this.onMessage)
            }
            _isFullscreenEnabled() {
                return Boolean(this._options.fullscreen && ve)
            }
            ...
            _requestFullscreen({
                ...
                return this._hasFullscreenElement() ? Promise.resolve() : t || this._isFullscreenEnabled() ? new Promise(((t, r) => {
                    e.Z.postToParent({
                        type: "screen-manager",
                        action: "request-fullscreen"
                    }).then(t).catch((e => {
                        ve = !1, console.error(e), r(e)
                    }))
                })) : Promise.reject(new Error("Fullscreen disabled"))
            }
            _exitFullscreen() {
                return this._hasFullscreenElement() ? new Promise(((t, r) => {
                    e.Z.postToParent({
                        type: "screen-manager",
            ...
            _toggleFullscreen({
                ...
                return t || this._isFullscreenEnabled() ? new Promise(((t, r) => {
                    e.Z.postToParent({
                        type: "screen-manager",
        ...
        const ye = class NativeShim {
            ...
            be = ye.Symbol("screenManagerInstance");
        class FullscreenManager {
            constructor(e) {
                ...
                }, this[be] = e, this._overrideBrowserFullscreenElement(), this._initMessaging()
            }
            get STATUS_ON() {
                return "on"
            }
            ...
            get status() {
                return this[be]._hasFullscreenElement() ? this.STATUS_ON : this.STATUS_OFF
            }
            request() {
                return this[be]._requestFullscreen({
                    force: !0
                })
            }
            exit() {
                return this[be]._exitFullscreen({
                    force: !0
                })
            }
            toggle() {
                return this[be]._toggleFullscreen({
                    force: !0
                })
            }
        ...
        class ScreenManagerPublic {
            constructor(e) {
                this[be] = new me(e), this.fullscreen = new FullscreenManager(this[be])
            }
        }
        ...
        var Ae = __webpack_require__(1420);
        ...
        var Le;
        ! function(e) {
            e.RU = "ru", e.EN = "en", e.BE = "be", e.UK = "uk", e.KK = "kk", e.UZ = "uz", e.TR = "tr"
        }(Le || (Le = {}));
        const Re = Le.RU;

        function getLocalizedString(e, t = Re, r = "") {
            if (e) {
                if ("string" == typeof e) return e;
                if (t in e) return e[t] || r;
                if (Re in e) return e[Re] || r
            }
            return r
        }
        var De;
        ...
        const Me = "//yastatic.net/s3/games-static/static-data/images/payments/sdk";
        let sendOnceCurrencyCodeStat = function() {
            sendOnceCurrencyCodeStat = () => {}, re.params({
                borrowParams: {
                    payments: {
                        appId: (0, i.rh)(),
        ...
        class Product {
            ...
            getPriceCurrencyImage(e = De.SMALL) {
                if (e === De.SVG) return "".concat(Me, "/currency-icon-m.svg");
                let t = "s";
                switch (e) {
                    case De.MEDIUM:
                    case De.SMALL:
                ...
                return "".concat(Me, "/currency-icon-").concat(t).concat(r ? "@2x" : "", ".png")
            }
            toJSON() {
                return {
                    id: this.id,
        ...
        const Ue = ye.Symbol("PurchaseData");
        class Purchase {
            constructor(e) {
                "purchaseTime" in e || (e.purchaseTime = 0), this[Ue] = e
            }
            get productID() {
                return this[Ue].productID
            }
            get purchaseTime() {
                return this[Ue].purchaseTime
            }
            get purchaseToken() {
                return this[Ue].purchaseToken
            }
            get developerPayload() {
                return this[Ue].developerPayload
            }
            toJSON() {
                return {
        ...
        function convertResponse(e) {
            if ("signature" in e) {
                ...
                if ("string" == typeof t) {
                    const {
                        data: e
                    } = JSON.parse(atobUTF16(t.split(".")[1]));
                    return {
                        data: e,
                        signature: t
                    }
                }
                console.error("response.signature is not a string")
            }
            return {
                data: e
            }
        ...
        class Payments {
            ...
            getCatalog() {
                return new Promise(((t, r) => {
                    e.Z.postToParent({
                        ...
                        je("get-catalog result", e), t(e.products.map((e => new Product(e))))
                    })).catch((e => {
                        r(e)
                    }))
                }))
            ...
            getPurchases() {
                return new Promise(((t, r) => {
                    e.Z.postToParent({
                        ...
                        je("getPurchases callback", e);
                        const n = e.map((e => new Purchase({
                            productID: e.product.id,
                            purchaseToken: e.token,
                            developerPayload: e.developerPayload
                        })));
                        defineSignatureProp(n, r), t(n)
                    })).catch((e => {
                        r(e)
                    }))
                }))
            ...
            consumePurchase(t) {
                return new Promise(((r, n) => {
                    e.Z.postToParent({
                        ...
                        if (console.info("consumePurchase data"), console.info(e), !e || !e.token) throw new Ae.Z({
            ...
            ___test1212Purchase(e) {
                function setStyleElement(t) {
                    const r = document.getElementById("payElement1212-".concat(e));
                    r && (r.style.backgroundColor = t ? "#0f0" : "#f00")
                }
                this.purchase({
                    id: e,
                    developerPayload: ""
                }).then((() => setStyleElement(!0))).catch((e => {
                    setStyleElement(!1), console.error(e)
                }))
            }
        }
        const Ne = function getPayments(e = {}) {
        ...
        function stringifyData(e) {
            try {
                ...
                return console.error(Je), "".concat(Date.now(), ".").concat(Math.random())
            }
        }
        class LastSendGuard {
            constructor(e) {
            ...
            validate(e) {
                ...
                return function byteLength(e) {
                    ...
                    error: new Error("The data is too large (bigger then ".concat(Fe, " bytes).")),
                    reject: !0
                } : this._dataHash === t ? {
        ...
        const He = ye.Symbol("PlayerData"),
            Be = ye.Symbol("PlayerConfig");
        ...
        class Player extends class PlayerBase {
            ...
            getID() {
                return console.error("Player.getID() is deprecated. Please, use Player.getUniqueID().\nhttps://yandex.ru/dev/games/doc/dg/sdk/sdk-player.html#sdk-player__profile-data"), re.sendOnceDeprecatedUsage("Player.getID"), this._personalInfo.id
            }
            getUniqueID() {
            ...
            getPhoto(e = "medium") {
                ...
                return this._personalInfo.avatarIdHash ? "".concat(se, "/avatar/").concat(this._personalInfo.avatarIdHash, "/").concat(t) : "".concat(ce).concat(oe, "/").concat(t)
            }
        } {
            constructor(e, t) {
                super(e), this[He] = void 0, this[Be] = t, Ye && Ye.isSamePlayer(this.getUniqueID()) || (Ye = new LastSendGuard(this.getUniqueID()))
            }
            getIDsPerGame() {
                return this._fetchData("-ids-per-game")
            }
            getData(e) {
                return void 0 === this[He] ? this._fetchData("/data").then((t => (this[He] = t, filterDataByKeys(t, e)))) : Promise.resolve(filterDataByKeys(this[He], e))
            }
            setData(e, t = !1) {
                ...
                this[He] = e;
                const r = function sendData(e, t = !1) {
                    const r = Ye.validate(e);
                    return r.error ? r.reject ? Promise.reject(r.error) : (console.error(r.error), Promise.resolve(!0)) : new Promise(((r, n) => {
                        qe && window.clearTimeout(qe);
                        let o = t ? 0 : Ye.getWaitTime();
                        Ye.timestamp = Date.now(), qe = window.setTimeout((() => {
                            fetch_postData("/data", e).then((() => {
                                Ye.dataHash = e, r(!0)
                            })).catch((e => {
                                Ye.timestamp = 0, Ye.dataHash = null, n(e)
                            }))
                        }), o)
                    }))
                }(e, t);
        ...
        class ScopesChecker {
            ...
            isNeedToAskUser() {
                return [Ve.AVATAR, Ve.NAME].some((e => this._requestedScopes.includes(e) && this._scopePermissions[e] === Ke.NOT_SET))
            }
            _validateRequestedScopes(e) {
                let t = [];
                t = Array.isArray(e) ? Array.from(e) : void 0 === e || !0 === e ? [We] : [];
                const r = t.indexOf(We);
                return -1 !== r && t.splice(r, 1, Ve.AVATAR, Ve.NAME), t
            }
        }

        function _getPlayer(t = {}, r = !0) {
            return e.Z.postToParent({
                type: "player",
                action: "fetch",
                data: {
                ...
                const {
                    data: n,
                    signature: o
                } = e, a = function createPlayer(e, t, r) {
                    const n = new Player(t, e);
                    return defineSignatureProp(n, r), n
                }(t, n, o);
                if ("lite" === a.getMode()) return a;
                const i = new ScopesChecker(n.scopePermissions, t.scopes);
                return r && i.isNeedToAskUser() ? i.show().then((() => _getPlayer(t, !1))).catch((() => a)) : a
            }))
        }
        ...
        (() => {
            ...
            if (-1 === window.location.hostname.indexOf("games.s3.yandex.net")) return;
            const e = (0, i.rh)();
            if (!e) return;
            const {
                search: t,
                hash: r
            } = window.location, n = "https://yandex.ru/games/play/".concat(e).concat(t).concat(r);
        ...
        let ze;
        getDebugLog("sdkv2")("APP_VERSION", "10119311");
        class YaGamesCreater {
            constructor(t) {
                t = ensureOptions(t), this.EVENTS = {
                    EXIT: fe.EXIT,
                    HISTORY_BACK: fe.HISTORY_BACK
                }, this.dispatchEvent = function getSdkEventsDispatcher() {
                    return function dispatchEvent(t, r) {
                        return new Promise(((n, o) => {
                            if (!(t in _e)) {
                                const e = "Yandex SDK Event ".concat(t, " is not in supported.");
                                return console.warn(e), void o(new Error(e))
                            }
                            const a = {
                                action: t,
                                type: "sdk-event"
                ...
                }(), this.onEvent = getSdkEventsHandler(), this.adv = new AdvManager(t), this.auth = V, this.clipboard = W, this.deviceInfo = X, this.environment = ee, this.feedback = Ze, this.shortcut = N, this.getLeaderboards = leaderboards, this.getPayments = v2_payments, this.getPlayer = get_player_getPlayer, this.getStorage = getStorage, this.notifications = de, this.screen = new ScreenManagerPublic(t.screen), this.yandexApp = {
                    enabled: y
                }
            }
        }
        ...
        class YaGames {
            ...
            static init(e) {
                return ze ? (console.warn("YaGames was initialized"), ze) : (ze = new Promise(((t, r) => {
                    const onFeaturesLoad = n => {
                        try {
                            e = ensureOptions(n, e), waitDocumentReady().then((() => {
                                var r, n;
                                const o = new YaGamesCreater(e);
                                ! function isNoAdsExperimentEnabled(e) {
                                    return isFlagEqualTo(e, O, !0)
                                }((null === (n = null === (r = window.YandexGamesSDKEnvironment) || void 0 === r ? void 0 : r.request) || void 0 === n ? void 0 : n.experiments) || {}) ? t(o): K.hasAuth() ? o.getPlayer({
                                    scopes: !1
                                }).then((() => t(o))).catch((() => t(o))) : t(o)
                            }))
                        } catch (o) {
                            console.error(o), r(o)
                        }
                    ...
                    window.loadEnvironmentPromise.then((() => {
                        ...
                        console.error("Init failed with error ".concat(e)), loadOptions().then(onFeaturesLoad).catch((e => {
                            console.warn("Options load failed with error ".concat(e)), onFeaturesLoad()
                        }))
                    }))
                })), ze)
        ...
        if (YaGames.deviceInfo = X, window.YaGames) {
            ...
            window.top !== window && waitDocumentReady().then(back_button_logic), Ee.overrideCacheSearch(), A()
        }
        window.YaGames = YaGames;
        const $e = YaGames
    })(), YaGames = r.default
})();
//# sourceMappingURL=https://s3.mdst.yandex.net/games/source-maps/v10119311/sdk/v2.js.map