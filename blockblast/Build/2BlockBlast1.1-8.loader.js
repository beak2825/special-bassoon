function createUnityInstance(t, n, l) {
    ...
    function r(e) {
        ...
        (n += "\n" + (r = r.startsWith(n) ? r.substring(n.length) : r).trim()) && u.stackTraceRegExp && u.stackTraceRegExp.test(n) && _(n, e.filename || t && (t.fileName || t.sourceURL) || "", e.lineno || t && (t.lineNumber || t.line) || 0)
    }
    ...
    var s, d, f, h, m, b, g, p, w, v = "",
        y = "",
        k = (document.addEventListener("webkitfullscreenchange", function(e) {
            document.webkitCurrentFullScreenElement === t ? t.style.width && (v = t.style.width, y = t.style.height, t.style.width = "100%", t.style.height = "100%") : v && (t.style.width = v, t.style.height = y, y = v = "")
    ...
    u.SystemInfo = function() {
        ...
        version: 1
    }, f = "RequestStore", h = "WebAssembly", m = window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB, b = null, S.getInstance = function() {
        return b = b || new S
    ...
    }, S.UnityCacheDatabase = s, S.RequestMetaDataStore = d, S.MaximumCacheSize = 1073741824, S.prototype.loadRequest = function(e) {
        var t = this;
        ...
        var o = this;
        return void 0 === m ? Promise.reject(new Error("Could not connect to cache: IndexedDB is not supported.")) : void 0 === window.caches ? Promise.reject(new Error("Could not connect to cache: Cache API is not supported.")) : new Promise(function(t, n) {
            try {
                function r() {
        ...
        e.objectStoreNames.contains(d.name) || (t = e.createObjectStore(d.name, {
            keyPath: "url"
        ...
        var r = this,
            ...
            a = [];
        return new Promise(function(t, n) {
            var e = r.database.transaction([d.name], "readonly").objectStore(d.name).openCursor();
        ...
        return this.getMetaDataEntries().then(function(e) {
            ...
            for (a = 0; a < o.length && !(n < S.MaximumCacheSize); ++a) r.push(o[a]), n -= o[a].size;
            return function e() {
                var t;
                return 0 === r.length ? Promise.resolve() : (t = r.pop(), i.cache.delete(t.url).then(function(e) {
                    if (e) return r = t.url, new Promise(function(e, t) {
                        ...
                        n.objectStore(d.name).delete(r), n.oncomplete = e, n.onerror = t
                    });
                    var r
                }).then(e))
            }()
        })
    }, S), u.cachedFetch = (g = u.UnityCache, p = u.fetchWithProgress, w = u.readBodyWithProgress, function(o, a) {
        ...
        function c(n, r) {
            return fetch(n, r).then(function(e) {
                ...
                return !l.enabled || l.revalidated ? e : 304 === e.status ? (l.revalidated = !0, i.updateRequestMetaData(l.metaData).then(function() {
                    C("'" + l.metaData.url + "' successfully revalidated and served from the indexedDB cache")
                }).catch(function(e) {
                    C("'" + l.metaData.url + "' successfully revalidated but not stored in the indexedDB cache due to the error: " + e)
                }), w(l.response, r.onProgress, r.enableStreamingDownload)) : 200 == e.status ? (l.response = e, l.metaData.updatedAt = l.metaData.accessedAt, l.revalidated = !0, t = e.clone(), w(e, r.onProgress, r.enableStreamingDownload).then(function(e) {
                    return l.metaData.size = e.parsedBody.length, Promise.all([i.storeRequest(n, t), i.updateRequestMetaData(l.metaData)]).then(function() {
                        C("'" + s + "' successfully downloaded and stored in the indexedDB cache")
                    }).catch(function(e) {
                        C("'" + s + "' successfully downloaded but not stored in the indexedDB cache due to the error: " + e)
                    }), e
                })) : (C("'" + s + "' request failed with status: " + e.status + " " + e.statusText), w(e, r.onProgress, r.enableStreamingDownload))
            })
        }
        return a && (l.control = a.control, l.companyName = a.companyName, l.productName = a.productName, l.productVersion = a.productVersion), l.revalidated = !1, l.metaData = {
            ...
            return e ? (n = e.response, r = e.metaData, l.response = n, l.metaData.size = r.size, l.metaData.updatedAt = r.updatedAt, "immutable" == l.control ? (l.revalidated = !0, i.updateRequestMetaData(r).then(function() {
                C("'" + l.metaData.url + "' served from the indexedDB cache without revalidation")
                ...
                return l.revalidated = ["Last-Modified", "ETag"].every(function(e) {
                    ...
                    C("'" + l.metaData.url + "' successfully revalidated and served from the indexedDB cache")
                }), w(l.response, a.onProgress, a.enableStreamingDownload)) : c(o, a)
            }))) : c(o, a)
        }).catch(function(e) {
            return C("Failed to load '" + l.metaData.url + "' from indexedDB cache due to the error: " + e), p(o, a)
        }) : p(o, a)
    });
    var U = {
        gzip: {
    ...
    function B() {
        Promise.all([D("frameworkUrl").then(function(e) {
    ...
    return new Promise(function(e, t) {
        ...
        }), B()) : t("Your browser does not support WebAssembly.") : t("Your browser does not support WebGL.")
    })
}