...
! function(e) {
    for (var n = t, i = (s = n.lib).WordArray, r = s.Hasher, s = n.algo, o = [], a = [], d = function(e) {
        ...
        c && (8 > l && (o[l] = d(e.pow(u, .5))), a[l] = d(e.pow(u, 1 / 3)), l++), u++
    }
    var f = [];
    s = s.SHA256 = r.extend({
        _doReset: function() {
        ...
        _doProcessBlock: function(e, n) {
            for (var t = this._hash.words, i = t[0], r = t[1], s = t[2], o = t[3], d = t[4], u = t[5], l = t[6], c = t[7], v = 0; 64 > v; v++) {
                ...
                g = c + ((d << 26 | d >>> 6) ^ (d << 21 | d >>> 11) ^ (d << 7 | d >>> 25)) + (d & u ^ ~d & l) + a[v] + f[v], m = ((i << 30 | i >>> 2) ^ (i << 19 | i >>> 13) ^ (i << 10 | i >>> 22)) + (i & r ^ i & s ^ r & s), c = l, l = u, u = d, d = o + g | 0, o = s, s = r, r = i, i = g + m | 0
            }
            t[0] = t[0] + i | 0, t[1] = t[1] + r | 0, t[2] = t[2] + s | 0, t[3] = t[3] + o | 0, t[4] = t[4] + d | 0, t[5] = t[5] + u | 0, t[6] = t[6] + l | 0, t[7] = t[7] + c | 0
        },
...
}(Math), n = (e = t).enc.Utf8, e.algo.HMAC = e.lib.Base.extend({
        init: function(e, t) {
            e = this._hasher = new e.init, "string" == typeof t && (t = n.parse(t));
            var i = e.blockSize,
                r = 4 * i;
            t.sigBytes > r && (t = e.finalize(t)), t.clamp();
            for (var s = this._oKey = t.clone(), o = this._iKey = t.clone(), a = s.words, d = o.words, u = 0; u < i; u++) a[u] ^= 1549556828, d[u] ^= 909522486;
            ...
            r = function() {
                ...
                return e.getHmac = function(e, n) {
                    ...
                    var t, i, r, s, o, a = "",
                        ...
                        l = 0;
                    do {
                        r = (t = n.charCodeAt(l++)) >> 2, s = (3 & t) << 4 | (i = n.charCodeAt(l++)) >> 4, o = (15 & i) << 2 | (d = n.charCodeAt(l++)) >> 6, u = 63 & d, isNaN(i) ? o = u = 64 : isNaN(d) && (u = 64), a = a + e.keyStr.charAt(r) + e.keyStr.charAt(s) + e.keyStr.charAt(o) + e.keyStr.charAt(u), t = i = d = 0, r = s = o = u = 0
                    } while (l < n.length);
                    return a
                    ...
                    var t, r, s, o, a = "",
                        ...
                        u = 0,
                        l = 0;
                    /[^A-Za-z0-9\+\/\=]/g.exec(n) && i.w("There were invalid base64 characters in the input text. Valid base64 characters are A-Z, a-z, 0-9, '+', '/',and '='. Expect errors in decoding."), n = n.replace(/[^A-Za-z0-9\+\/\=]/g, "");
                    do {
                        t = e.keyStr.indexOf(n.charAt(l++)) << 2 | (s = e.keyStr.indexOf(n.charAt(l++))) >> 4, r = (15 & s) << 4 | (o = e.keyStr.indexOf(n.charAt(l++))) >> 2, d = (3 & o) << 6 | (u = e.keyStr.indexOf(n.charAt(l++))), a += String.fromCharCode(t), 64 != o && (a += String.fromCharCode(r)), 64 != u && (a += String.fromCharCode(d)), t = r = d = 0, s = o = u = 0
                    } while (l < n.length);
                    return decodeURI(a)
    ...
    ! function(n) {
        ...
        var u = function() {
            ...
            return n.validateBusinessEvent = function(e, i, u, l, c) {
                ...
                if (c && !l && u) return t.w("Validation fail - progression event: 03 found but 01+02 are invalid. Progression must be set as either 01, 01+02 or 01+02+03."), new d(r.EventValidation, s.ProgressionEvent, o.WrongProgressionOrder, a.Undefined, u + ":" + l + ":" + c);
                if (l && !u) return t.w("Validation fail - progression event: 02 found but not 01. Progression must be set as either 01, 01+02 or 01+02+03"), new d(r.EventValidation, s.ProgressionEvent, o.WrongProgressionOrder, a.Undefined, u + ":" + l + ":" + c);
                if (!u) return t.w("Validation fail - progression event: progression01 not valid. Progressions must be set as either 01, 01+02 or 01+02+03"), new d(r.EventValidation, s.ProgressionEvent, o.WrongProgressionOrder, a.Undefined, (u || "") + ":" + (l || "") + ":" + (c || ""));
                ...
                if (l) {
                    if (!n.validateEventPartLength(l, !0)) return t.w("Validation fail - progression event - progression02: Cannot be empty or above 64 characters. String: " + l), new d(r.EventValidation, s.ProgressionEvent, o.InvalidEventPartLength, a.Progression02, l);
                    if (!n.validateEventPartCharacters(l)) return t.w("Validation fail - progression event - progression02: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: " + l), new d(r.EventValidation, s.ProgressionEvent, o.InvalidEventPartCharacters, a.Progression02, l)
                }
                if (c) {
                    if (!n.validateEventPartLength(c, !0)) return t.w("Validation fail - progression event - progression03: Cannot be empty or above 64 characters. String: " + c), new d(r.EventValidation, s.ProgressionEvent, o.InvalidEventPartLength, a.Progression03, c);
                    if (!n.validateEventPartCharacters(c)) return t.w("Validation fail - progression event - progression03: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: " + c), new d(r.EventValidation, s.ProgressionEvent, o.InvalidEventPartCharacters, a.Progression03, c)
                }
                return null
        ...
        var t = e.validators.GAValidator,
            ...
            u = function() {
                ...
                return e.setUserId = function(n) {
                    ...
                    if (t.validateConnectionType(r) && (n.connection_type = r), o.gameEngineVersion && (n.engine_version = o.gameEngineVersion), e.instance.configurations) {
                        var s = 0;
                    ...
                    n.event_uuid = i.createGuid(), n.category = e.CategorySdkError, n.sdk_version = o.getRelevantSdkVersion(), n.os_version = o.osVersion, n.manufacturer = o.deviceManufacturer, n.device = o.deviceModel, n.platform = o.buildPlatform;
                    var r = o.getConnectionType();
                    return t.validateConnectionType(r) && (n.connection_type = r), o.gameEngineVersion && (n.engine_version = o.gameEngineVersion), n
                }, e.getInitAnnotations = function() {
                    var n = {};
                    return e.getIdentifier() || e.cacheIdentifier(), s.setItem(e.getGameKey(), e.LastUsedIdentifierKey, e.getIdentifier()), n.user_id = e.getIdentifier(), n.sdk_version = o.getRelevantSdkVersion(), n.os_version = o.osVersion, n.platform = o.buildPlatform, e.getBuild() ? n.build = e.getBuild() : n.build = null, n.session_num = e.getSessionNum(), n.random_salt = e.getSessionNum(), n
                    ...
                    if (t) {
                        ...
                        if (o) {
                            ...
                            null != d && d != e.getIdentifier() && (r.w("New identifier spotted compared to last one used, clearing cached configs hash!!"), o.configs_hash && delete o.configs_hash), n.sdkConfigCached = o
                        }
                    }
                                ...
                                if (o < e.MAX_CUSTOM_FIELDS_COUNT) {
                                    ...
                                    if (i.stringMatch(a, u)) {
                                        ...
                                        if ("string" === l || d instanceof String) {
                                            var c = d;
                                            if (c.length <= e.MAX_CUSTOM_FIELDS_VALUE_STRING_LENGTH && c.length > 0) s[a] = c, ++o;
                                            else {
                                                g = "validateAndCleanCustomFields: entry with key={0}, value={1} has been omitted because its value is an empty string or exceeds the max number of characters (" + e.MAX_CUSTOM_FIELDS_VALUE_STRING_LENGTH + ")", f = e.formatString(g, [a, d]);
                                                r.w(f), t && t(g, f)
                                            }
                                            ...
                                            g = "validateAndCleanCustomFields: entry with key={0}, value={1} has been omitted because its value is not a string or number", f = e.formatString(g, [a, d]);
                                            r.w(f), t && t(g, f)
                                        }
                                    } else {
                                        g = "validateAndCleanCustomFields: entry with key={0}, value={1} has been omitted because its key contains illegal character, is empty or exceeds the max number of characters (" + e.MAX_CUSTOM_FIELDS_KEY_LENGTH + ")", f = e.formatString(g, [a, d]);
                                        r.w(f), t && t(g, f)
                                    }
                                } else {
                                    g = "validateAndCleanCustomFields: entry with key={0}, value={1} has been omitted because it exceeds the max number of custom fields (" + e.MAX_CUSTOM_FIELDS_COUNT + ")", f = e.formatString(g, [a, d]);
                                    r.w(f), t && t(g, f)
                                }
                            else {
                ...
                return e.prototype.requestInit = function(i, r) {
                    ...
                    if (d) {
                        var u = this.createPayloadData(d, this.useGzip),
                            l = [];
                        l.push(d), e.sendRequest(o, u, l, this.useGzip, e.initRequestCallback, r)
                    ...
                    if (0 != i.length) {
                        ...
                        if (d) {
                            var u = this.createPayloadData(d, this.useGzip),
                                l = [];
                            l.push(d), l.push(r), l.push(i.length.toString()), e.sendRequest(a, u, l, this.useGzip, e.sendEventInArrayRequestCallback, s)
                    ...
                    if (t.isEventSubmissionEnabled() && s.validateSdkErrorEvent(l, c, n, r, a)) {
                        var v, g = this.baseUrl + "/" + l + "/" + this.eventsUrlPath,
                            f = "",
                        ...
                        if (A.length > 0 && (m.error_parameter = A), u.length > 0) {
                            var S = u;
                            if (u.length > e.MAX_ERROR_MESSAGE_LENGTH) S = u.substring(0, e.MAX_ERROR_MESSAGE_LENGTH);
                            m.reason = S
                        }
                        var y = [];
                        y.push(m), (v = JSON.stringify(y)) ? o.execute(g, f, v, c) : i.w("sendSdkErrorEvent: JSON encoding failed.")
                    }
                    ...
                    if (m == n.EGAHTTPApiResponse.Ok || m == n.EGAHTTPApiResponse.Created || m == n.EGAHTTPApiResponse.BadRequest) {
                        ...
                        if (null == E) return s(n.EGAHTTPApiResponse.JsonDecodeFailed, null, g, f), void e.instance.sendSdkErrorEvent(a.Http, d.EventsHttp, u.FailHttpJsonDecode, l.Undefined, c, t.getGameKey(), t.getGameSecret());
                    ...
                    if (d.onreadystatechange = function() {
                        ...
                        }, d.open("POST", e, !0), d.setRequestHeader("Content-Type", "application/json"), d.setRequestHeader("Authorization", l), s) throw new Error("gzip not supported");
                    try {
                        d.send(n)
                    } catch (e) {
                    ...
                    if (m == n.EGAHTTPApiResponse.Ok || m == n.EGAHTTPApiResponse.Created || m == n.EGAHTTPApiResponse.BadRequest) {
                        if (null == f) return o(n.EGAHTTPApiResponse.JsonDecodeFailed, null, "", 0), void e.instance.sendSdkErrorEvent(a.Http, d.InitHttp, u.FailHttpJsonDecode, l.Undefined, v, t.getGameKey(), t.getGameSecret());
...
function(e) {
    ...
    n = e.events || (e.events = {}), t = e.store.GAStore, i = e.store.EGAStore, r = e.store.EGAStoreArgsOperator, s = e.state.GAState, o = e.logging.GALogger, a = e.utilities.GAUtilities, d = e.http.EGAHTTPApiResponse, u = e.http.GAHTTPApi, l = e.validators.GAValidator, c = function() {
        function c() {}
        return c.customEventFieldsErrorCallback = function(n, t) {
            if (s.isEventSubmissionEnabled()) {
                var i = new Date;
                c.timestampMap[n] || (c.timestampMap[n] = i), c.countMap[n] || (c.countMap[n] = 0), (i.getTime() - c.timestampMap[n].getTime()) / 1e3 >= 3600 && (c.timestampMap[n] = i, c.countMap[n] = 0), c.countMap[n] >= c.MAX_ERROR_COUNT || e.threading.GAThreading.performTaskOnGAThread((function() {
            ...
            if (s.isEventSubmissionEnabled()) {
                var e = {};
                e.category = c.CategorySessionStart, s.incrementSessionNum(), t.setItem(s.getGameKey(), s.SessionNumKey, s.getSessionNum().toString()), c.addDimensionsToEvent(e);
                var n = s.instance.currentGlobalCustomEventFields;
                c.addCustomFieldsToEvent(e, s.validateAndCleanCustomFields(n, c.customEventFieldsErrorCallback)), c.addEventToStore(e), o.i("Add SESSION START event"), c.processEvents(c.CategorySessionStart, !1)
            }
            ...
            if (s.isEventSubmissionEnabled()) {
                ...
                c.addCustomFieldsToEvent(t, s.validateAndCleanCustomFields(i, c.customEventFieldsErrorCallback)), c.addEventToStore(t), o.i("Add SESSION END event."), c.processEvents("", !1)
            }
            ...
            if (void 0 === a && (a = null), s.isEventSubmissionEnabled()) {
                ...
                if (null == g) {
                    var f = {};
                    s.incrementTransactionNum(), t.setItem(s.getGameKey(), s.TransactionNumKey, s.getTransactionNum().toString()), f.event_id = i + ":" + r, f.category = c.CategoryBusiness, f.currency = e, f.amount = n, f[s.TransactionNumKey] = s.getTransactionNum(), a && (f.cart_type = a), c.addDimensionsToEvent(f);
                    var m = {};
                    if (d && Object.keys(d).length > 0)
                        for (var E in d) m[E] = d[E];
                    else
                        for (var E in s.instance.currentGlobalCustomEventFields) m[E] = s.instance.currentGlobalCustomEventFields[E];
                    if (v && d && Object.keys(d).length > 0)
                        for (var E in s.instance.currentGlobalCustomEventFields) m[E] || (m[E] = s.instance.currentGlobalCustomEventFields[E]);
                    c.addCustomFieldsToEvent(f, s.validateAndCleanCustomFields(m, c.customEventFieldsErrorCallback)), o.i("Add BUSINESS event: {currency:" + e + ", amount:" + n + ", itemType:" + i + ", itemId:" + r + ", cartType:" + a + "}"), c.addEventToStore(f)
                } else u.instance.sendSdkErrorEvent(g.category, g.area, g.action, g.parameter, g.reason, s.getGameKey(), s.getGameSecret())
            }
            ...
            if (s.isEventSubmissionEnabled()) {
                ...
                if (null == g) {
                    ...
                    f.event_id = m + ":" + t + ":" + r + ":" + a, f.category = c.CategoryResource, f.amount = i, c.addDimensionsToEvent(f);
                    var E = {};
                    if (d && Object.keys(d).length > 0)
                        for (var p in d) E[p] = d[p];
                    else
                        for (var p in s.instance.currentGlobalCustomEventFields) E[p] = s.instance.currentGlobalCustomEventFields[p];
                    if (v && d && Object.keys(d).length > 0)
                        for (var p in s.instance.currentGlobalCustomEventFields) E[p] || (E[p] = s.instance.currentGlobalCustomEventFields[p]);
                    c.addCustomFieldsToEvent(f, s.validateAndCleanCustomFields(E, c.customEventFieldsErrorCallback)), o.i("Add RESOURCE event: {currency:" + t + ", amount:" + i + ", itemType:" + r + ", itemId:" + a + "}"), c.addEventToStore(f)
                } else u.instance.sendSdkErrorEvent(g.category, g.area, g.action, g.parameter, g.reason, s.getGameKey(), s.getGameSecret())
            }
            ...
            if (s.isEventSubmissionEnabled()) {
                ...
                if (null == m) {
                    var E, p = {};
                    E = i ? r ? t + ":" + i + ":" + r : t + ":" + i : t, p.category = c.CategoryProgression, p.event_id = f + ":" + E;
                    var h = 0;
                    d && n != e.EGAProgressionStatus.Start && (p.score = Math.round(a)), n === e.EGAProgressionStatus.Fail && s.incrementProgressionTries(E), n === e.EGAProgressionStatus.Complete && (s.incrementProgressionTries(E), h = s.getProgressionTries(E), p.attempt_num = h, s.clearProgressionTries(E)), c.addDimensionsToEvent(p);
                    var A = {};
                    if (v && Object.keys(v).length > 0)
                        for (var S in v) A[S] = v[S];
                    else
                        for (var S in s.instance.currentGlobalCustomEventFields) A[S] = s.instance.currentGlobalCustomEventFields[S];
                    if (g && v && Object.keys(v).length > 0)
                        for (var S in s.instance.currentGlobalCustomEventFields) A[S] || (A[S] = s.instance.currentGlobalCustomEventFields[S]);
                    c.addCustomFieldsToEvent(p, s.validateAndCleanCustomFields(A, c.customEventFieldsErrorCallback)), o.i("Add PROGRESSION event: {status:" + f + ", progression01:" + t + ", progression02:" + i + ", progression03:" + r + ", score:" + a + ", attempt:" + h + "}"), c.addEventToStore(p)
                } else u.instance.sendSdkErrorEvent(m.category, m.area, m.action, m.parameter, m.reason, s.getGameKey(), s.getGameSecret())
            }
            ...
            if (s.isEventSubmissionEnabled()) {
                ...
                if (null == a) {
                    ...
                    if (i && Object.keys(i).length > 0)
                        ...
                        for (var g in s.instance.currentGlobalCustomEventFields) v[g] = s.instance.currentGlobalCustomEventFields[g];
                    if (r && i && Object.keys(i).length > 0)
                        for (var g in s.instance.currentGlobalCustomEventFields) v[g] || (v[g] = s.instance.currentGlobalCustomEventFields[g]);
                    c.addCustomFieldsToEvent(d, s.validateAndCleanCustomFields(v, c.customEventFieldsErrorCallback)), o.i("Add DESIGN event: {eventId:" + e + ", value:" + n + "}"), c.addEventToStore(d)
                } else u.instance.sendSdkErrorEvent(a.category, a.area, a.action, a.parameter, a.reason, s.getGameKey(), s.getGameSecret())
            }
            ...
            if (void 0 === r && (r = !1), s.isEventSubmissionEnabled()) {
                ...
                if (null == d) {
                    var v = {};
                    if (v.category = c.CategoryError, v.severity = a, v.message = n, c.addDimensionsToEvent(v), !r) {
                        var g = {};
                    ...
                    o.i("Add ERROR event: {severity:" + a + ", message:" + n + "}"), c.addEventToStore(v)
                } else u.instance.sendSdkErrorEvent(d.category, d.area, d.action, d.parameter, d.reason, s.getGameKey(), s.getGameSecret())
            }
            ...
            if (s.isEventSubmissionEnabled()) {
                ...
                if (null == h) {
                    ...
                    if (g && Object.keys(g).length > 0)
                        ...
                        for (var y in s.instance.currentGlobalCustomEventFields) S[y] = s.instance.currentGlobalCustomEventFields[y];
                    if (f && g && Object.keys(g).length > 0)
                        for (var y in s.instance.currentGlobalCustomEventFields) S[y] || (S[y] = s.instance.currentGlobalCustomEventFields[y]);
                    c.addCustomFieldsToEvent(A, s.validateAndCleanCustomFields(S, c.customEventFieldsErrorCallback)), o.i("Add AD event: {ad_sdk_name:" + i + ", ad_placement:" + r + ", ad_type:" + E + ", ad_action:" + m + (n == e.EGAAdAction.FailedShow && p.length > 0 ? ", ad_fail_show_reason:" + p : "") + (!v || t != e.EGAAdType.RewardedVideo && t != e.EGAAdType.Video ? "" : ", ad_duration:" + d) + "}"), c.addEventToStore(A)
                } else u.instance.sendSdkErrorEvent(h.category, h.area, h.action, h.parameter, h.reason, s.getGameKey(), s.getGameSecret())
            }
            ...
            if (s.isEventSubmissionEnabled()) try {
                ...
                var f = [];
                f.push(["status", r.Equal, "new"]), e && (g.push(["category", r.Equal, e]), f.push(["category", r.Equal, e]));
                var m = [];
                m.push(["status", v]);
                var E = t.select(i.Events, g);
                if (!E || 0 == E.length) return o.i("Event queue: No events to send"), void c.updateSessionStore();
                if (E.length > c.MaxEventCount) {
                    if (!(E = t.select(i.Events, g, !0, c.MaxEventCount))) return;
                    var p = E[E.length - 1].client_ts;
                    if (g.push(["client_ts", r.LessOrEqual, p]), !(E = t.select(i.Events, g))) return;
                    f.push(["client_ts", r.LessOrEqual, p])
                }
                if (o.i("Event queue: Sending " + E.length + " events."), !t.update(i.Events, m, f)) return;
                for (var h = [], A = 0; A < E.length; ++A) {
                    var S = E[A],
                        y = JSON.parse(a.decode64(S.event));
                    if (0 != y.length) {
                        var b = y.client_ts;
                        b && !l.validateClientTs(b) && delete y.client_ts, h.push(y)
                    }
                }
                u.instance.sendEventsInArray(h, v, c.processEventsCallback)
            } catch (e) {
                o.e("Error during ProcessEvents(): " + e.stack), u.instance.sendSdkErrorEvent(n.EGASdkErrorCategory.Json, n.EGASdkErrorArea.ProcessEvents, n.EGASdkErrorAction.JsonError, n.EGASdkErrorParameter.Undefined, e.stack, s.getGameKey(), s.getGameSecret())
            }
            ...
            if (u.push(["status", r.Equal, s]), e === d.Ok) t.delete(i.Events, u), o.i("Event queue: " + a + " events sent.");
                ...
                var l = [];
                l.push(["status", "new"]), o.w("Event queue: Failed to send events to collector - Retrying next time"), t.update(i.Events, l, u)
            } else {
                if (n) {
                    var c, v = 0;
            ...
            if (s.isEventSubmissionEnabled())
                if (s.isInitialized()) try {
                    ...
                    g.category = d.category, g.session_id = d.session_id, g.client_ts = d.client_ts, g.event = a.encode64(JSON.stringify(d)), t.insert(i.Events, g), e.category == c.CategorySessionEnd ? t.delete(i.Sessions, [
                        ["session_id", r.Equal, d.session_id]
                    ]) : c.updateSessionStore(), t.isStorageAvailable() && t.save(s.getGameKey())
                } catch (l) {
                    o.e("addEventToStore: error"), o.e(l.stack), u.instance.sendSdkErrorEvent(n.EGASdkErrorCategory.Database, n.EGASdkErrorArea.AddEventsToStore, n.EGASdkErrorAction.DatabaseTooLarge, n.EGASdkErrorParameter.Undefined, l.stack, s.getGameKey(), s.getGameSecret())
            ...
            if (s.sessionIsStarted()) {
                ...
                c.addCustomFieldsToEvent(n, s.validateAndCleanCustomFields(r, c.customEventFieldsErrorCallback)), e.event = a.encode64(JSON.stringify(n)), t.insert(i.Sessions, e, !0, "session_id"), t.isStorageAvailable() && t.save(s.getGameKey())
            }
        ...
        }, c.CategorySessionStart = "user", c.CategorySessionEnd = "session_end", c.CategoryDesign = "design", c.CategoryBusiness = "business", c.CategoryProgression = "progression", c.CategoryResource = "resource", c.CategoryError = "error", c.CategoryAds = "ads", c.MaxEventCount = 500, c.MAX_ERROR_COUNT = 10, c.countMap = {}, c.timestampMap = {}, c
    }(), n.GAEvents = c
}(i || (i = {})),
function(e) {
    ! function(n) {
    ...
    var n = e.threading.GAThreading,
        ...
        c = function() {
            ...
            return c.getGlobalObject = function() {
                ...
                s.async = !0, c.initTimedBlockId = s.id, s.block = function() {
                    c.isSdkReady(!0, !1) ? t.w("SDK already initialized. Can only be called once.") : a.validateKeys(e, i) ? (r.setKeys(e, i), c.internalInitialize()) : t.w("SDK failed initialize. Game key or secret key is invalid. Can only contain characters A-z 0-9, gameKey is 32 length, gameSecret is 40 length. Failed keys - gameKey: " + e + ", secretKey: " + i)
                }, n.performTimedBlockOnGAThread(s)
            }, c.addBusinessEvent = function(e, t, i, s, a, d, u) {
                if (void 0 === e && (e = ""), void 0 === t && (t = 0), void 0 === i && (i = ""), void 0 === s && (s = ""), void 0 === a && (a = ""), void 0 === d && (d = {}), void 0 === u && (u = !1), o.updateConnectionType(), r.instance.isUnloading) {
                    if (!c.isSdkReady(!0, !0, "Could not add business event")) return;
                    l.addBusinessEvent(e, t, i, s, a, d, u)
                } else n.performTaskOnGAThread((function() {
                    c.isSdkReady(!0, !0, "Could not add business event") && l.addBusinessEvent(e, t, i, s, a, d, u)
                }))
            }, c.addResourceEvent = function(t, i, s, a, d, u, v) {
                if (void 0 === t && (t = e.EGAResourceFlowType.Undefined), void 0 === i && (i = ""), void 0 === s && (s = 0), void 0 === a && (a = ""), void 0 === d && (d = ""), void 0 === u && (u = {}), void 0 === v && (v = !1), o.updateConnectionType(), r.instance.isUnloading) {
                ...
                if (void 0 === t && (t = e.EGAProgressionStatus.Undefined), void 0 === i && (i = ""), void 0 === s && (s = ""), void 0 === a && (a = ""), void 0 === u && (u = {}), void 0 === v && (v = !1), o.updateConnectionType(), r.instance.isUnloading) {
                    if (!c.isSdkReady(!0, !0, "Could not add progression event")) return;
                ...
                if (void 0 === i && (i = {}), void 0 === s && (s = !1), o.updateConnectionType(), r.instance.isUnloading) {
                ...
                if (void 0 === t && (t = e.EGAErrorSeverity.Undefined), void 0 === i && (i = ""), void 0 === s && (s = {}), void 0 === a && (a = !1), o.updateConnectionType(), r.instance.isUnloading) {
                ...
                if (void 0 === t && (t = e.EGAAdAction.Undefined), void 0 === i && (i = e.EGAAdType.Undefined), void 0 === s && (s = ""), void 0 === a && (a = ""), void 0 === d && (d = e.EGAAdError.Undefined), void 0 === u && (u = {}), void 0 === v && (v = !1), o.updateConnectionType(), r.instance.isUnloading) {
                ...
                if (void 0 === t && (t = e.EGAAdAction.Undefined), void 0 === i && (i = e.EGAAdType.Undefined), void 0 === s && (s = ""), void 0 === a && (a = ""), void 0 === d && (d = 0), void 0 === u && (u = {}), void 0 === v && (v = !1), o.updateConnectionType(), r.instance.isUnloading) {
                    if (!c.isSdkReady(!0, !0, "Could not add ad event")) return;
                ...
                if (void 0 === t && (t = e.EGAAdAction.Undefined), void 0 === i && (i = e.EGAAdType.Undefined), void 0 === s && (s = ""), void 0 === a && (a = ""), void 0 === d && (d = {}), void 0 === u && (u = !1), o.updateConnectionType(), r.instance.isUnloading) {
                    if (!c.isSdkReady(!0, !0, "Could not add ad event")) return;
                ...
                void 0 === e && (e = {}), n.performTaskOnGAThread((function() {
                    t.i("Set global custom event fields: " + JSON.stringify(e)), r.instance.currentGlobalCustomEventFields = e
                }))
                ...
                if (r.isInitialized()) {
                    ...
                    e.async = !0, c.initTimedBlockId = e.id, e.block = function() {
                        r.isEnabled() && r.sessionIsStarted() && n.endSessionAndStopQueue(), c.resumeSessionAndStartQueue()
                ...
                r.ensurePersistedStates(), i.setItem(r.getGameKey(), r.DefaultUserIdKey, r.getDefaultId()), r.setInitialized(!0), c.newSession(), r.isEnabled() && n.ensureEventQueueIsRunning()
            }, c.newSession = function() {
                t.i("Starting a new session."), r.validateAndFixCurrentDimensions(), s.instance.requestInit(r.instance.configsHash, c.startNewSessionCallback)
                ...
                var g = u.createGuid();
                r.instance.sessionId = g, r.instance.sessionStart = r.getClientTsAdjusted(), l.addSessionStartEvent();
                var f = n.getTimedBlockById(c.initTimedBlockId);
                null != f && (f.running = !1), c.initTimedBlockId = -1
            }, c.resumeSessionAndStartQueue = function() {
                r.isInitialized() && (t.i("Resuming session."), r.sessionIsStarted() || c.newSession())
            ...
            }, c.initTimedBlockId = -1, c.methodMap = {}, c
        }();
    e.GameAnalytics = c
}(i || (i = {})), i.GameAnalytics.init();
